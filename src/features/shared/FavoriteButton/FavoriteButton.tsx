...
interface IFavoriteButtonProps {
  fn?: (id: string) => void
  role: 'favorite' | 'delete'
};

export const FavoriteButton: React.FC<IFavoriteButtonProps> = ({ fn, role }) => {
